        ...
        <form id="toolIDsForm" method="post">
            <fieldset class="input__container">
                ...
                for ($i = 1; $i <= $cantidad; $i++) {
                    ...
                    echo '<input readonly class="input__field" id="toolID' . $i . '" name="toolID' . $i . '" required />';
                ...
                while ($row = mysqli_fetch_assoc($sql_result)) {
                    ...
                    <label class="input__label" for="toolID">
                        <input readonly class="input__field" id="toolID" value="<?php echo $row['id_herramienta'] ?>">
