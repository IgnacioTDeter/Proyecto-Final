            ...
            <tr class="tr" data-row-id="<?php echo $rowId; ?>">
              ...
              <td class="table__cell">
                <div class="btn-group">
                  ...
                  <a href="form_editOrders.php?edit=<?php echo $row['id_pedido']; ?>"
                    class="btn__table btn__table-yellow"><i class="ri-pencil-fill"></i></a>
                  <a href="../php/deleteOrder.php?id_pedido=<?php echo $row['id_pedido']; ?>"
                    class="btn__table btn__table-red delete-button" delete-id=<?php echo $rowId; ?> id="deleteOrder"><i
                      class="ri-close-circle-fill"></i></a>
                </div>
              </td>

              <td>
                <button class="btn__popup fas fa-exclamation-triangle"
                  onclick="openPopup('<?php echo $row['profesor'] ?>', '<?php echo $row['curso'] ?>', '<?php echo $row['dia'] ?>', '<?php echo $row['id_pedido'] ?>')"></button>
              </td>
            </tr>
