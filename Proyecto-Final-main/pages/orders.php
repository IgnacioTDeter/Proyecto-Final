        ...
        <tbody>
          ...
          ?>
            ...
            <tr class="custom-dropdown-row table__header-item table__header-item-0" style="display: none;" data-row-id="<?php echo $rowId; ?>">
              <th class="" colspan="5" style="background-color: hsl(0, 0%, 25%); border: solid 1px grey">Herramienta</th>
              <th class="" colspan="1" style="background-color: hsl(0, 0%, 25%); border: solid 1px grey">Cantidad</th>
            ...
            ?>
              <tr class="custom-dropdown-row" style="display: none;" data-row-id="<?php echo $rowId; ?>">
                <td colspan="5" class="table__cell" style="background-color: rgba(255, 255, 27, 0.470);">
                  <?php echo $row['herramienta']; ?>
                </td>
                <td colspan="1" class="table__cell" style="background-color: rgba(255, 255, 27, 0.470);">
